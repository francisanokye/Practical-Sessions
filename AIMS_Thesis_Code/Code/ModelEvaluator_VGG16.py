...
pr = skplt.metrics.plot_precision_recall(ground_truth, predicted_classes, figsize=(
    7, 7), title="Precision-Recall curve for VGG16 classifier")
print(pr)

roc = skplt.metrics.plot_roc(ground_truth, predicted_classes, figsize=(
    7, 7), title="ROC curve for VGG16 classifier", plot_macro=True, plot_micro=True)
print(roc)
########################################################################################################
# Show the errors
"""
